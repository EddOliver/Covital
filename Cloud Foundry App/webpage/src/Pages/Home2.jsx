...
import mxstates from './Home2/states/mexico.json';
import {TwitterTweetEmbed} from 'react-twitter-embed';
import ReactDOM from "react-dom"
import TwitterIcon from '@material-ui/icons/Twitter';
import MailOutlineIcon from '@material-ui/icons/MailOutline';
import ResizableIconButton from "./Home2/components/ResizeButton.jsx"
import EqualizerIcon from '@material-ui/icons/Equalizer';
import RedditIcon from '@material-ui/icons/Reddit';
import twitterd from './Home2/td.svg'
...
import Alert from "./Home2/components/Alert.js"
...
// core components
import PanelHeader from "./Home2/components/PanelHeader/PanelHeader.jsx";

import {
  chartColor,
  gradientChartOptionsConfigurationWithNumbersAndGrid
} from "./Home2/variables/charts.jsx";


var namestates= ["Aguascalientes","Baja California","Baja California Sur","Campeche","Coahuila","Colima","Chiapas","Chihuahua","Mexico City","Durango","Guanajuato","Guerrero","Hidalgo","Jalisco","State of Mexico","Michoacan","Morelos","Nayarit","Nuevo Leon","Oaxaca","Puebla","Queretaro","Quintana Roo","San Luis Potosi","Sinaloa","Sonora","Tabasco","Tamaulipas","Tlaxcala","Veracruz","Yucatan","Zacatecas"]
...
class Home2 extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      graphlabel:[],
      graphdata:[],
      graphtitle:"Confirmed Cases 2020",
      widget:icons[6],
      windgetcolor:"#black",
      widgetname:"Real Time Twitter Analysis",
      dlat:22,
      dlng:-92,
      percentage:"",
      chartlabel:"Positives"
    };
...
left(){
  ...
  componentWillMount(){
   ...
   graphdatavar=[null]
    ...
    var options1 = {
        'method': 'GET',
        'url': 'https://XXXXXXXX.us-south.apigw.appdomain.cloud/covital/carousel-en',
        'headers': {
  ...
  //
    ...
    if (isMobile) {
        ...
        <PanelHeader
          ...
          content={
            ...
            <img style={{maxHeight:"72%"}} src="https://covital-bucket.s3.us-south.cloud-object-storage.appdomain.cloud/iconmodm.png" alt="Smiley face" />
              ...
              <Col xs="8">
              <h2 style={{color:"#bc8d03"}}>Covital <br /> Initiative</h2> 
            </Col>
          </Row>
          <Row style={{position: "relative",bottom: "30%"}}>
            <Col>
            <h5 style={{padding:"3%", color:"white", textAlign: "justify",textJustify: "inter-word"}}>COVID19 information aggregator and data platform for Mexico</h5>
            </Col>
          </Row>
          ...
          <img style={{width:"42px",position: "relative",top: "4px"}} src={MEX} />
          </ResizableIconButton>
          </Link>
          </Col>
         {/* <Col xs="auto">
        ...
        />
          ...
          <div className="content">
            <Row>
              ...
              <div style={{padding: "2%"}}>
                <Card>
                <CardTitle tag="h4">&nbsp;&nbsp;Confirmed Cases Map</CardTitle>
      ...
      />
              ...
              <Card>
                  ...
                  <Row md="2">
                  <Col xs="auto">
                  <CardTitle tag="h4">Data <FontAwesomeIcon style={{color: "black",display:this.state.lockstate}} icon={faLock} /> 
                    </CardTitle>
                    </Col>
                    <Col xs="auto">
                    <Dropdown style={{display:this.state.mapview}} group isOpen={this.state.dropdownOpen} size="lg" toggle={()=>this.drop()}>
                      ...
                      >
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(32,datain["total"])}>National</DropdownItem>
                        ...
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(8,datain["totalr"][8])}>Mexico City</DropdownItem>
                        ...
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(14,datain["totalr"][14])}>State of Mexico</DropdownItem>
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(15,datain["totalr"][15])}>Michoacan</DropdownItem>
                        ...
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(18,datain["totalr"][18])}>Nuevo Leon</DropdownItem>
                        ...
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(21,datain["totalr"][21])}>Queretaro</DropdownItem>
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(22,datain["totalr"][22])}>Quintana Roo</DropdownItem>
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(23,datain["totalr"][23])}>San Luis Potosi</DropdownItem>
                        ...
                        <DropdownItem style={{fontSize:"20px"}} onClick={() => this.handleClic(30,datain["totalr"][30])}>Yucatan</DropdownItem>
                    ...
                    <Table responsive>
                      <thead className="text-primary">
                        <tr>
                          ...
                          <th className="text-right">Susp</th>
            ...
            <div style={{padding: "5%"}}>
              ...
              >
              <span style={{fontSize: "150%"}}>Correct Hand Washing technique</span>
               </Alert>
      ...
      <div className="button-container">
        ...
        >
           <FontAwesomeIcon size="3x" style={{color: "black"}} icon={faChevronRight} />
              ...
              >
              <span style={{fontSize: "150%"}}>Facemasks : Different types and correct use</span>
               </Alert>
      ...
      <div className="button-container">
        ...
        >
           <FontAwesomeIcon size="3x" style={{color: "black"}} icon={faChevronRight} />
              ...
              >
              <span style={{fontSize: "150%"}}>Phases and preventive measures during the pandemic</span>
               </Alert>
      ...
      <div className="button-container">
        ...
        >
           <FontAwesomeIcon size="3x" style={{color: "black"}} icon={faChevronRight} />
              ...
              >
              <span style={{fontSize: "150%"}} >Symptoms</span>
               </Alert>
      ...
      <div className="button-container">
        ...
        >
           <FontAwesomeIcon size="3x" style={{color: "black"}} icon={faChevronRight} />
              ...
              >
              <span style={{fontSize: "150%"}} >What to do if you suspect you have COVID-19?</span>
               </Alert>
      ...
      <div className="button-container">
        ...
        >
           <FontAwesomeIcon size="3x" style={{color: "black"}} icon={faChevronRight} />
              ...
              >
              <span style={{fontSize: "150%"}} >Official Information Sources</span>
               </Alert>
    ...
    <Row md="2">
          <Col md="7">
            <div style={{padding: "2%"}}>
          <Card>
          <CardTitle tag="h4">&nbsp;&nbsp;&nbsp;Emotional Positivity Map<br />&nbsp;&nbsp;&nbsp;by State</CardTitle>
    ...
    <Card className="card-chart">
                ...
                <h3 style={{ textAlign:"center"}}> {this.state.percentage+"%"} Emotional Positivity</h3>
                ...
                Psychological analysis of emotions through
                <a style={{ color:"#38A1F3"}} > Twitter </a> to know the mental health of the population during the COVID-19 quarantine
                </CardFooter>
                </Col>
                </Row>
              </Card>
    ...
    <Container fluid={true}>
          <Card >
          <CardTitle tag="h4">Last News</CardTitle>
          <div style={{padding: "1%"}}>
          <Row md="3">
          <Col xs="auto">
          <div id="t1"> 
      ...
      <Container fluid={true}>
          <Card >
          <CardTitle tag="h4">Fake News</CardTitle>
          <div style={{padding: "1%"}}>
          <Row md="3">
          <Col xs="auto">
          <div id="t4">
        ...
        <PanelHeader
          ...
          content={
            ...
            <img src="https://covital-bucket.s3.us-south.cloud-object-storage.appdomain.cloud/Logo/iconmod.png" alt="Smiley face" />
              ...
              <Col xs="5">
              <h1 style={{color:"#bc8d03"}}>Covital Initiative</h1> 
              <h3 style={{color:"white"}}>COVID19 information aggregator <br></br>and data platform for Mexico </h3>
            </Col>
            <Col style={{position: "relative",left: "70px",bottom: "0px"}} xs="4" sm={{offset: 1}}>
...
<img style={{ position: "relative",top: "15%"}} src="https://covital-bucket.s3.us-south.cloud-object-storage.appdomain.cloud/desklogo2.png" alt="Smiley face" />
</Card>
<Card className="card-user" style={{display: this.state.visibles[0]}}>
    <div className="image">
      <img alt="..." src={this.state.imageb} />
  ...
  <Row md="2">
          <Col md="7">
            <div style={{padding: "2%"}}>
          <Card>
          <CardTitle tag="h4" >&nbsp;&nbsp;Emotional Positivity Map by State</CardTitle>
          <CardBody style={{display:this.state.mapviewt}}>
          <div
                    id="map"
                    className="map"
    ...
    <Card className="card-chart">
                ...
                <FontAwesomeIcon size="3x" style={{ color:this.state.windgetcolor, fontSize:"2000%",textAlign:"center"}} icon={this.state.widget} />
                    ...
                    <h5 style={{ textAlign:"center"}}> <p /> {this.state.percentage+"%"} Emotional Positivity</h5>
                </CardBody>
                </div>
                <CardFooter style={{ color:"black", fontSize:"170%",textAlign:"center"}}>
                Psychological analysis of emotions through<br />
                <a style={{ color:"#38A1F3"}} > Twitter </a>, to know the mental health of the population during the COVID-19 quarantine.
                </CardFooter>
                </Col>
                </Row>

...
import mxstates from './states/mexico.json';
import {TwitterTweetEmbed} from 'react-twitter-embed';
import ReactDOM from "react-dom"
import TwitterIcon from '@material-ui/icons/Twitter';
import MailOutlineIcon from '@material-ui/icons/MailOutline';
import ResizableIconButton from "./components/ResizeButton.jsx"
import EqualizerIcon from '@material-ui/icons/Equalizer';
import RedditIcon from '@material-ui/icons/Reddit';
import twitterd from './td.svg'
...
left(){
  ...
  componentWillMount(){
    ...
    var options1 = {
        'method': 'GET',
        'url': 'https://xxxxxxxxxx.us-south.apigw.appdomain.cloud/covital-mexico/car',
        'headers': {
          'accept': 'application/json',
          'x-ibm-client-id': 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
        }
      };
...
var options2 = {
  'method': 'GET',
  'url': 'https://xxxxxxxxxx.us-south.apigw.appdomain.cloud/covital-mexico/mex',
  'headers': {
...
request2(options2, function (error, response) {   
  ...
  for (var i = 0; i < datain["totalr"].length; i++) {
    if((parseFloat(datain["totalr"][i]["pos"])/max) < (.3))
    {
        mycolor=(254*(1-(parseFloat(datain["totalr"][i]["pos"])/(max*.3)))).toFixed()
...
var options6 = {
  'method': 'GET',
  'url': 'https://xxxxxxxxxxxxxxx.us-south.apigw.appdomain.cloud/covital-mexico/twitter-cos',
  'headers': {
    'accept': 'application/json',
    'x-ibm-client-id': 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
}
};
request6(options6, function (error, response) { 
  if (error) throw new Error(error);
  var sentjson=JSON.parse(JSON.parse(response.body)["message"])
  var mymin=1
  var mymax=0
  for (var i = 0; i < 32; i++) {
...
var options4 = {
  'method': 'GET',
  'url': 'https://xxxxxxxxxx.us-south.apigw.appdomain.cloud/covital-mexico/news',
  'headers': {
    'x-ibm-client-id': 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
  }
};
...
request4(options4, function (error, response) { 
  ...
  ReactDOM.render(element, document.getElementById('t6'));
      ...
      const mymarker = { url: require("./aguila.svg"), scaledSize: {width: 40, height: 40}};
      const mymarker2 = { url: require("./mar.svg"), scaledSize: {width: 230, height: 160}};
        ...
        <PanelHeader
          ...
          content={
            ...
            <Row md="2" style={{position: "relative",left: "20px",bottom: "26%"}}>
              <Col xs="auto">
            <img style={{maxHeight:"72%"}} src="https://covital-bucket.s3.us-south.cloud-object-storage.appdomain.cloud/Logo/iconmod.png" alt="Smiley face" />
            </Col>
              <Col xs="8">
        ...
        <PanelHeader
          ...
          content={
            ...
            <img src="https://covital-bucket.s3.us-south.cloud-object-storage.appdomain.cloud/Logo/iconmod.png" alt="Smiley face" />
              ...
              <h3 style={{color:"white"}}>Plataforma de información y datos para México sobre <br /> COVID-19</h3>
            </Col>

...
The 2019–20 coronavirus pandemic was confirmed to have reached Mexico in February 2020. However, the National Council of Science and Technology (CONACYT) reported two cases of COVID-19 in mid-January 2020 in the states of Nayarit and Tabasco, one case per state.
...
On 7 March, a seventh case was also confirmed in Mexico City in a 46-year-old male who had previously had contact with another confirmed case in the United States.
...
On 12 March, Mexico announced it had a total of 15 confirmed cases, with new cases in Puebla and Durango. A day later, senator Samuel García Sepúlveda accused the federal government of hiding the true number of confirmed cases.
...
We decided the scope and the additional service that we will provide;
To focus on a regional solution as we can have a bigger impact like this. 
And we will attack perhaps the two problems that are the most neglected. 
The first one is fake information and the emotional state of people
And the second is neglecting the health and long working hours that expose doctors and frontliners to become the most representative group regarding the virus. And noone is developing anything for their well being
 
Our Solution is a COVID19 information aggregator and data platform for Mexico, that includes IoT risk assessing devices for medical professionals.
 
Lets go though the aggregator first:
...
First we have the map by state that shows the number of cases in an easy manner and a graph that shows the growth of that.

Then we have the most important actions that a person has to take in order to prevent the spread and instructions on how to do so, such as how to properly wash hands, symptoms of the disease, social distancing and what to do if you think that you have the disease.
 
And next is where the Machine learning enters and what is most neglected right now, the Emotional Positivity Map 
by state that shows the mental state of each one of the provinces.  This was done by a Machine learning algorithm that browses through twitter, selects those tweets from the province in question and assigns a positivity measure via the Tone Analyzer service, of course we first translated the tweet via another service before. Along the days we have proved that this service work as the state coincides with important news that happened in each province 
Lastly we have a service that separates the real news from the fake news and by just reading the tweets published we can get up to date on the issues.
...
These kinds of measures have shown to decrease considerably the risk of these professionals.
...
By now there are 6875 Cases of COVID19 in Mexico, we will rush development and launch this week. 
